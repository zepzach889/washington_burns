...
const WBT_MUSEUM_GALLERIES = [
  { title: 'The American Presidency: From Washington to Nakamura', floor: 'Level 1 · East Wing', img: '/washington_burns/images/amhistory/wash_2_naka.png', desc: "Two centuries of executive leadership — objects, documents, and portraits tracing every president from the republic's founding to the present day.", highlights: "Washington's dress sword and camp chest · the trowel from the Washington House cornerstone laying, 1821 · the ceremonial key from the Museum's 1879 opening" },
  { title: 'Iron Nation: Two Centuries of American Rail', floor: 'Level 1 · West Wing', img: '/washington_burns/images/amhistory/railroad1.jpg', desc: 'From the founding of the USRC in 1834 to the modern high-speed network — the story of how rail shaped the American continent.', highlights: 'The original USRC founding charter of 1834 · a restored 1850s passenger locomotive · two centuries of timetables, tickets, and rail maps' },
  { title: 'War Between the States, 1857-1860: The Crisis That Remade America', floor: 'Level 2 · Central Hall', img: '/washington_burns/images/amhistory/war_between_states1.png', desc: 'The defining conflict of the nineteenth century — from the collapse of the Hawthorne government to the Philadelphia Convention and the Constitution of 1861.', highlights: "The pen used to sign the Constitution of 1861 at Philadelphia · President Brandt's personal copy of the 1861 Constitution · preserved regimental standards" },
  { title: 'The Global War: America and the World, 1932-1940', floor: 'Level 2 · North Gallery', img: '/washington_burns/images/amhistory/global_war.jpg', desc: "America's defining international conflict — from the first Prussian advances to the Treaty of Geneva and the founding of the Global Peace Council.", highlights: "The American delegation's materials from the Treaty of Geneva · a soldier's field kit and letters home · wartime homefront posters" },
  { title: 'Votes and Voices: Two Centuries of American Democracy', floor: 'Level 3 · South Gallery', img: '/washington_burns/images/amhistory/suffrage1.jpg', desc: 'From the first elections under the 1787 Constitution to the Third Amendment and universal suffrage — the long arc of democratic participation in America.', highlights: 'An original printing of the Declaration of Equal Standing, Northampton 1847 · nineteenth-century ballot boxes · banners of the suffrage movement' },
  { title: 'American Arts & Material Culture, 1814-Present', floor: 'Level 3 · East Gallery', img: '/washington_burns/images/amhistory/am_arts.jpg', desc: 'Objects, artworks, and everyday items tracing American material life from the founding of Franklin to the present — furniture, fashion, fine art, and folk tradition.', highlights: "Furnishings from Franklin's founding generation · American folk art and quilts · two centuries of American dress" },
];
...
const LV_FILMS = [
...

  {
    ...
    studio: 'Castillo Pictures',
    platform: null,
    synopsis: "The cycle's most distinctly entry — a revenant tied to the Mississippi River, drowned and returned. Geographically and culturally rooted in the river-valley gothic tradition.",
...

  {
    ...
    studio: 'Castillo Pictures',
    platform: null,
    synopsis: "The first of Castillo Picture's Gothic Horror reimaginings, recreating the iconic 'He Comes at Night' film from the 1920s: a European predator arriving in an American gothic setting.",
    poster: 'cinema_he_comes_at_night_2020_poster.png',
  },

  {
    id: 'moon-changer-2022',
    title: 'Moon Changer',
    year: '2022',
    genre: 'Horror',
    section: 'horror',
    ...
    studio: 'Castillo Pictures',
    platform: null,
    synopsis: "The second installment in Castillo Picture's Gothic Horror reimaginings, recreating the werewolf classic, 'Moon Changer' from the 1930s",
    poster: 'cinema_moon_changer_2022_poster.png',
  },

  {
    ...
    studio: 'Castillo Pictures',
    platform: null,
    synopsis: "The third installment in Castillo Picture's Gothic Horror reimaginings, recreating 'The Drowned,' from 1933.",
    poster: 'cinema_drowned_2023_poster.png',
  },

  {
    id: 'what-calls-in-hunger-2025',
    title: 'What Calls in Hunger',
    year: '2025',
    genre: 'Horror',
    section: 'horror',
    ...
    studio: 'Castillo Pictures',
    platform: null,
    synopsis: "The fourth installment in Castillo Picture's Gothic Horror reimaginings, recreating 'What Calls in Hunger' from 1934. Drawing on Wendigo mythology (Algonquian-speaking peoples). The film's Algonquian director helped bring in a mostly Native cast, and a better respect for his people's legends.",
    poster: 'cinema_what_calls_in_hunger_2025_poster.png',
  },
