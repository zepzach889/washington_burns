...
const NEDEX_ARTICLES = [
  ...
  { title: 'Hafız Ibrahim Karahan',                file: 'bio-karahan.html',            categories: ['Biographies', 'Ottoman Empire', 'Grand Viziers', 'Islamic scholars'],                                                            blurb: 'Ottoman Islamic scholar and Grand Vizier (1915–1917); suspended the constitution and elevated religious courts during the Karahan Interlude; overthrown by Kemal Şahin\'s restorative coup; sentenced to internal exile.' },
  { title: 'Kemal Şahin',                          file: 'bio-sahin.html',              categories: ['Biographies', 'Ottoman Empire', 'Grand Viziers', 'New Ottoman Era'],                                                             blurb: 'Ottoman military officer and Grand Vizier (1917–c.1927); led the restorative coup that ended the Karahan Interlude; principal architect of the New Ottoman Era\'s pan-Ottoman nationalist project; negotiated the Istanbul Accord (1919).' },
  { title: 'Mahmud III',                           file: 'bio-mahmud3.html',            categories: ['Biographies', 'Ottoman Empire', 'Sultans', 'New Ottoman Era'],                                                                   blurb: '37th Sultan of the Ottoman Empire (from 1917); born Şehzade Mehmed Ziyaeddin; ascended following Kemal Şahin\'s restorative coup; physician, musician, and pan-Ottoman idealist; presided over the New Ottoman Era\'s foundational decade.' },
