...
const NEDEX_ARTICLES = [
  ...
  { title: 'History of the Texas Federation',      file: 'hist_of_texas.html',          categories: ['History', 'North American history', 'Texas Federation'],                                                                                  blurb: 'Full account of the political and social history of the Texas Federation from independence to the present.' },
    ...
    // ── LISTS of Leaders ──
  { title: 'Monarchs of Hawaiʻi',                  file: 'monarchs-hawaii.html',        categories: ['Lists', 'Hawaiʻi', 'Reference lists', 'Monarchs', 'Kamehameha Dynasty', 'North American Union'],                                                        blurb: 'Reference list with biographical notes; Kamehameha Dynasty from unification (c. 1795) to the present; 11 monarchs including Queen Kaʻahulani (1929–1983) and incumbent Kamehameha IX (2018–present).' },  { title: 'Monarchs of the United Kingdom',       file: 'monarchs-uk.html',         categories: ['United Kingdom', 'Reference lists', 'Monarchs', 'House of Westminster'],                                                                        blurb: 'Reference list with biographical notes; British monarchs from George I (1714) to Victor I (2011–present), across five royal houses.' },
