...
const NEDEX_ARTICLES = [
  ...
  { title: 'Peter Landon',                         file: 'peter-landon.html',       categories: ['Biographies', 'Presidents of the United States', 'Federalist Party politicians', 'Guilded Age', 'Wars and Conflics'],                blurb: 'Twenty-second President of the United States (1903-1905); First Black man to serve as president, attempted to oversee the growing crisis in Cuba with the Matanzas Clique.' },
  { title: 'Cornelius Roosevelt II',               file: 'cornelius-roosevelt-ii.html',       categories: ['Biographies', 'Presidents of the United States', 'Federalist Party politicians', 'Guilded Age', 'Wars and Conflics'],                blurb: 'Twenty-third President of the United States (1905-1911); Popular war-time president, oversaw the destruction of the Matanzas Clique in Cuba, and the country\'s post-war recovery and a wave of national pride.' },
